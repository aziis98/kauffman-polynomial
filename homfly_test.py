...
def test_homfly_K6_1():
    ...
    p_K6_1 = homfly_polynomial(link_sgc).simplify().expand()
    p_K6_1_expected = (
        z ** 0 * (v ** (-2)-v ** 2+v ** 4) +
        z ** 2 * (-1-v ** 2)
    ).simplify().expand()
...
# def test_homfly_L6a4_0_0():
#     link_sgc = PDCode.from_tuples([
#         (6, 1, 7, 2), (12, 8, 9, 7), (4, 12, 1, 11),
#         (10, 5, 11, 6), (8, 4, 5, 3), (2, 9, 3, 10)
#     ]).to_signed_gauss_code()

#     P_result = homfly_polynomial(link_sgc)

#     P_expected = (
#         -2/z ** 2 + 1/(v ** 2*z ** 2) + v ** 2/z ** 2 + 2 *
#         z ** 2-z ** 2/v ** 2-v ** 2*z ** 2 + z ** 4
#     )
